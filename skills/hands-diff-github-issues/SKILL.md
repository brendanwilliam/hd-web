...
4. Fetch `origin`, inspect the worktree, and create exactly one branch from `origin/main`: `feature/<issue>-<slug>`, `fix/<issue>-<slug>`, or `chore/<issue>-<slug>`.
5. Target `main` and include `Closes #<issue>` in the same-repository issue-backed PR body.
